...
def plot_pyramid_model(settings, to_file=None):
    ...
    pyramid_faces = [[pyramid_vertices[i], pyramid_vertices[j], pyramid_vertices[4]] for i in range(4) for j in range(i+1, 4)]
